...
SUPABASE_URL,
SUPABASE_KEY,
{ auth: { storageKey: "lumina-site-auth" } }
);
...
const produtos = [
  ...
  { slug:"lpfl-pro",  nome:"LPFL PRO",       categoria:"PRO",   descricao:"Versão premium do LPFL.",        gratuito:false, pagina:"checkout.html?produto=lumina-plus" }
];
