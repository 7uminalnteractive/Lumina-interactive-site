...
/* Espera o site-nav.js terminar de popular os links dinâmicos
   (navbar/rodapé) antes de rodar a lógica acima, para não ter
   conflito de quem escreve por cima de quem. Se o evento nunca
   disparar por algum motivo, roda de qualquer forma após 1.5s. */
(function () {
  let executado = false;
  function rodar() {
    if (executado) return;
  ...
  document.addEventListener("site-nav-pronto", rodar);
